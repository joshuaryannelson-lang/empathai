// app/analytics/utilization/page.tsx
// Module 4: Therapist Utilization — stub page (coming soon)
    ...
    <div style={{ minHeight: "100vh", background: "#080c12", color: "#f1f5f9", fontFamily: "'DM Sans', system-ui" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 80px" }}>
        ...
        <div style={{ fontSize: 13, color: "#94a3b8", marginBottom: 32 }}>
          Caseload vs. capacity at a glance. Identify burnout risk and coverage gaps before they affect care.
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13, color: "#64748b", maxWidth: 420, margin: "0 auto", lineHeight: 1.6 }}>
            It will show caseload vs. capacity and help identify burnout risk and coverage gaps.
          </div>
        </div>
      </div>
    </div>
