...
const PAGES: PageSection[] = [
  ...
  },
  {
    ...
    checks: [
      ...
      "Each panel shows a status (green for healthy, red for issues) and how fast each one responds",
  ...
  },
  {
    ...
    checks: [
      ...
      "Each service shows how many times it has been used and whether it is working properly",
